...
char *Sum(char *funzione_1,char *funzione_2, char *somma)
	{
		...
		if(funzione_1[0] == 'm' || funzione_1[0] == 's' || funzione_1[0] == 'p' || funzione_1[0] == 'c'|| funzione_1[0] == 'd')
		...
		if(funzione_2[0]=='m' || funzione_2[0]=='s' || funzione_2[0]=='p' || funzione_2[0] == 'c'|| funzione_2[0] == 'd' )
